...
class ModelVisualizer:
    ...
    def show_deformable_kernels(self, net, loader, config, deform_idx=0):
        ...
        test_feats = [np.zeros((l.shape[0], 3)) for l in loader.dataset.input_labels]
        ...
        for epoch in range(config.max_epoch):
            ...
            for batch in loader:
                ...
                ###############################
                #stacked_probs_copy = softmax(outputs).cpu().detach().numpy()
                s_points_copy = batch.points[0].cpu().numpy()
                lengths_copy = batch.lengths[0].cpu().numpy()
                in_inds_copy = batch.input_inds.cpu().numpy()
                cloud_inds_copy = batch.cloud_inds.cpu().numpy()
                #print(s_points_copy.shape)
                #print(r)
                ###############################
                ...
                for b_i, length in enumerate(batch.lengths[0]):
                    ...
                    # Get prediction
                    #points = s_points_copy[i0:i0 + length]
                    #probs = stacked_probs_copy[i0:i0 + length]
                    inds = in_inds_copy[i0:i0 + length]
                    c_i = cloud_inds_copy[b_i]

                    in_points.append(batch.points[0][i0:i0 + length].cpu().detach().numpy())
                    in_inds.append(batch.input_inds[i0:i0 + length].cpu().detach().numpy())
                    ...
                    #print(test_feats[0][inds].shape)
                    #print(test_feats[c_i][inds].shape)
                    #print(c_i)
                    #print(inds.shape)
                    #print(in_colors[0].shape)
                    #print(test_feats[c_i][inds].shape)
                    #print(in_colors.shape)
                ...
                #print(len(in_points))
                #op_1=np.concatenate((in_points[0], in_colors[0]), axis=1)
                #op_2=np.concatenate((in_points[1], in_colors[1]), axis=1)
                #op_3=np.concatenate((in_points[2], in_colors[2]), axis=1)
                #np.savetxt("/content/gdrive/MyDrive/KPConv_3/KPConv-PyTorch-master/feature_points/F1.txt", op_1)
                #np.savetxt("/content/gdrive/MyDrive/KPConv_3/KPConv-PyTorch-master/feature_points/F2.txt", op_2)
                #np.savetxt("/content/gdrive/MyDrive/KPConv_3/KPConv-PyTorch-master/feature_points/F3.txt", op_3)
                #print(op_1.shape)
                #print(op_2.shape)
                #print(op_3.shape)
                print(test_feats[0].shape)
                np.savetxt("/content/gdrive/MyDrive/KPConv_3/KPConv-PyTorch-master/feature_points/TFF.txt", test_feats[0])
                print(r)
                #vr = np.concatenate((vr, op_1), axis=0)
                #print("done")
        ...
        #print(deform_conv.shape)
        #return
        #np.savetxt("/content/gdrive/MyDrive/KPConv_3/KPConv-PyTorch-master/feature_points/vr.txt", vr)
        #print(vr.shape)
